---
title: "HS project"
subtitle: "Trajectory from HFSCs using TInGa"
author: "Audrey"
...
This script is used to infer trajectory from HFSCs, using TInGa.
...
We color cells according to gene expression :

```{r plot_dimred_gene, fig.width = 12, fig.height = 12}
dynplot::plot_dimred(trajectory = my_traj,
                     label_milestones = FALSE,
                     size_milestones = 0,
                     plot_trajectory = TRUE,
                     dimred = sobj[[traj_umap]]@cell.embeddings,
                     feature_oi = "EPCAM",
                     expression_source = Matrix::t(sobj@assays$RNA@data),
                     color_trajectory = "none")
```
