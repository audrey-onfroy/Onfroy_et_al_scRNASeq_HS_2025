...
cell_markers = list(
  ...
  "ORS" = c("GPX2", "IMPA2", "KRT15", "DST", "COL17A1", "MOXD1", "C19orf48", "CHD7",
            "ALDH3A1", "AHNAK2", "CDH13", "LAMB3", "CAVIN1", "EHF", "CEBPD", "TP53AIP1"),
  "IFE" = c("GPX2", "IMPA2", "DEFB1", "LY6D", "EHF", "PDZK1IP1", "S100A7", "FGFBP1", "LYPD3",
            "CRABP2", "SPINK5", "KRT1", "KRTDAP", "CIDEA", "SUSD4", "FAM83A", "TMEM45A"),
  "HFSC" = c("KRT15", "DST", "DIO2", "TCEAL2", "SFRP1", "TNC", "WIF1", "FRZB", "LHX2", "SPRY1",
...
color_markers = c("CD4 T cells" = "slateblue3",
                  "CD8 T cells" = "mediumpurple1",
                  "Langerhans cells" = "khaki3", 
                  "macrophages" = "olivedrab",
                  "B cells" = "aquamarine3",
                  "cuticle" = "magenta4",
                  "cortex" = "orchid1",
                  "medulla" = "lightpink",
